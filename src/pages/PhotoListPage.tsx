      ...
      <div className="mt-8">
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="p-4" ref={contentRef}>
            <h3 className="text-lg leading-6 font-medium text-gray-900 mb-6 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {staff.map((member) => (
                <div
                  key={member.id}
                  className="bg-white rounded-lg shadow overflow-hidden border border-gray-200 flex flex-col items-center p-4 hover:shadow-lg transition-shadow duration-200"
                >
                  <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-gray-100 mb-4 shadow-sm">
                    <img
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Employee #: {member.empl_no}</p>
                    <p className="text-xs text-gray-500">ID: {member.id_no}</p>
                  </div>
                </div>
              ))}
            </div>
